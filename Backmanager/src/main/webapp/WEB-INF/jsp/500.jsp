	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li>后台管理系统</li>
				<li class="active">500页面</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">500页面 <small>后台管理系统</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">500页面</h4>
                        </div>
                        <div class="panel-body">
                        	<h1>很抱歉~</h1>
                        	<h3>你所需要页面无法正确显示</h3>
                        	<div style="display: none;">${detailMessage}</div>
						</div>
					</div>
                    <!-- end panel -->
			    </div>
