...
var handleThemePageStructureControl = function() {
    if ($.cookie && $.cookie("theme")) {
        ...
        var e = ctx+"/assets/css/theme/" + $.cookie("theme") + ".css";
        $("#theme").attr("href", e)
    }
    ...
    function() {
        var e = ctx+"/assets/css/theme/" + $(this).attr("data-theme") + ".css";
        $("#theme").attr("href", e);
